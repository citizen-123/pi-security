#!/usr/bin/env python3
"""Generate and post-process Pi Security scan worklists.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Pi Security scan worklist helper.")
    ...
    bind = subparsers.add_parser(
        "bind-repo-scopes",
        help="Copy externally managed scoped-path targets into the unsealed manifest and coverage documents.",
    )
