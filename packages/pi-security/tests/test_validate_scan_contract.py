...
EXAMPLE_SCAN = Path(__file__).resolve().parent / "fixtures" / "completed-scan"


def load_validator() -> ModuleType:
    script = PACKAGE_ROOT / "scripts" / "validate_scan_contract.py"
...
class ValidateScanContractTest(unittest.TestCase):
    ...
    def test_finalizer_then_validator_cli_smoke(self) -> None:
        ...
        finalizer = PACKAGE_ROOT / "scripts" / "finalize_scan_contract.py"
        validator = PACKAGE_ROOT / "scripts" / "validate_scan_contract.py"
