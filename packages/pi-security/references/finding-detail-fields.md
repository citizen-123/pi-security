...
For every reportable finding in `findings.json`, preserve the validated reasoning and the exact source snippets that prove it. The Pi Security workspace renders these fields directly; it does not recover missing analysis from `report.md` or read source files after the scan.
  ...
  "codeEvidence": [
    {
      ...
      "path": "pi-rs/app-server-protocol/src/protocol/v2/environment.rs",
      "startLine": 6,
      "endLine": 12,
      "language": "rust",
      "role": "user_input",
    ...
    },
    {
      ...
      "path": "pi-rs/app-server/src/request_processors/environment_processor.rs",
      "startLine": 15,
      "endLine": 22,
      "language": "rust",
      "role": "entrypoint",
    ...
    },
    {
      ...
      "path": "pi-rs/exec-server/src/environment.rs",
      "startLine": 167,
      "endLine": 176,
      "language": "rust",
