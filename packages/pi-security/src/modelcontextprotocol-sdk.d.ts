...
declare module "@modelcontextprotocol/sdk/server/mcp.js" {
  ...
  export class McpServer {
    ...
    readonly server: {
      ...
      createMessage(
        params: import("@modelcontextprotocol/sdk/types.js").CreateMessageRequestParamsWithTools,
        options?: { signal?: AbortSignal; timeout?: number }
      ): Promise<import("@modelcontextprotocol/sdk/types.js").CreateMessageResultWithTools>;
      elicitInput(
        params: {
          mode: "form";
          message: string;
