...
import attackPathSchema from "../schemas/tools/candidate-attack-paths.schema.json" with { type: "json" };
...
export async function recordPiSecurityCandidateAttackPaths(
  ...
  await replaceArtifactJsonl(context, destination, updatedRows);
