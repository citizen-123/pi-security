...
const MISSING_PYTHON_HELPER_MESSAGE = "Pi Security could not start its Python 3 helper. Reinstall or update Pi to restore its bundled Python runtime, or set PI_SECURITY_PYTHON_COMMAND (preferred) or PYTHON to a working Python 3 executable, then restart Pi.";
